    ...
    return (
      <Menu style={menuStyle} attached="top" borderless inverted>
        <Menu.Item as={NavLink} activeClassName="" exact to="/">
          <Image size='small' src="/images/Icon.png"/>
        </Menu.Item>
        {this.props.currentUser ? (
            [<Menu.Item as={NavLink} activeClassName="active" exact to="/add" key='add'>Add Recipe</Menu.Item>,
              ...
              <Menu.Item as={NavLink} activeClassName="active" exact to="/searchR" key='searchR'>Search Recipe</Menu.Item>,
              <Menu.Item as={NavLink} activeClassName="active" exact to="/searchV" key='searchV'>Search Vendor</Menu.Item>]
        ) : ''}
        {this.props.currentUser === '' ? (
            [<Menu.Item as={NavLink} activeClassName="active" exact to="/searchR" key='searchR'>Search Recipe</Menu.Item>,
              <Menu.Item as={NavLink} activeClassName="active" exact to="/searchV" key='searchV'>Search Vendor</Menu.Item>]
